...
/* pages/submit.twig */
class __TwigTemplate_7199f5e0fff0886d3bbeb548d98f3d9a3bfee07b7389e801165d1c699f17dfd9 extends Twig_Template
{
...
";
            ...
            // line 38
            echo "\t<p>Выбрано соревнование: <span dir=\"auto\">";
...
\t\t";
            ...
            if (((isset($context["upload_state"]) ? $context["upload_state"] : null) == "error")) {
                // line 62
                echo "\t\t<div class=\"shj_error\">Ошибка заргузки файла.</div>
\t\t";
            } elseif (((isset($context["upload_state"]) ? $context["upload_state"] : null) == "ok")) {
                // line 64
                echo "\t\t<div class=\"shj_ok\">Файл успешно загружен. Смотрите результат в 'Все попытки'.</div>
\t\t";
            }
            // line 66
            echo "\t</p>
